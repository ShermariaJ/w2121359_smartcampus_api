...
This project is a RESTful Smart Campus API built using Java JAX-RS (Jersey). It is designed to manage rooms across campus, sensors placed inside rooms, and historical sensor readings.
